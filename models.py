...
class Exclusivity(BaseModel):
    ...
    exclusivity_date = DateField(column_name='Exclusivity_Date', null=True)
...
class Patent(BaseModel):
    ...
    patent_expire_date = DateField(column_name='Patent_Expire_Date', null=True)
    patent_no = TextField(column_name='Patent_No', null=True)
    patent_use_code = TextField(column_name='Patent_Use_Code', null=True)
    product_no = IntegerField(column_name='Product_No', null=True)
    submission_date = DateField(column_name='Submission_Date', null=True)
    index = IntegerField(index=True, null=True)
...
class Product(BaseModel):
    ...
    approval_date = DateField(column_name='Approval_Date', null=True)
